...
urlpatterns = [
    ...
    path('hosting_01/', views.Brand.hosting01, name='hosting_01'),
    path('hosting_02/', views.Brand.hosting02, name='hosting_02'),
    path('hosting_03/', views.Brand.hosting03, name='hosting_03'),
